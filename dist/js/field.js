...
/* harmony import */ var _Dropdown_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Dropdown.vue */ "./resources/js/components/Dropdown.vue");
//
//
//
//
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    blocksNames: function blocksNames() {
      return new collect_js__WEBPACK_IMPORTED_MODULE_0__.Collection(this.field.blocks).map(function (block) {
        return block.label;
      }).sort().all();
    }
  },
...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-content-blocks', _components_IndexField_vue__WEBPACK_IMPORTED_MODULE_0__["default"]);
  Vue.component('detail-content-blocks', _components_DetailField_vue__WEBPACK_IMPORTED_MODULE_1__["default"]);
  Vue.component('form-content-blocks', _components_FormField_vue__WEBPACK_IMPORTED_MODULE_2__["default"]);
});
...
var render = function () {
  ...
  return _c(
    "div",
    { staticClass: "cb-relative cb-inline-block cb-text-left" },
    [
      _c("div", [
        _c(
          "button",
          ...
          [
            ...
            _c(
              "svg",
              {
                staticClass: "-cb-mr-1 cb-ml-2 cb-h-5 cb-w-5",
                attrs: {
      ...
      _c(
        ...
        {
          staticClass:
            "cb-origin-top-right cb-absolute cb-right-0 cb-mt-2 cb-w-56 cb-rounded-md cb-shadow-lg cb-bg-white cb-ring-1 cb-ring-black cb-ring-opacity-5 focus:cb-outline-none",
          attrs: {
            role: "menu",
        ...
        [
          _c(
            "div",
            { staticClass: "cb-py-1", attrs: { role: "none" } },
            _vm._l(_vm.blocks, function (block, index) {
              return _c(
                "button",
                {
                  key: index,
                  staticClass:
                    "cb-text-gray-700 cb-block cb-px-4 cb-py-2 cb-text-sm",
                  attrs: {
                    role: "menuitem",
                    tabindex: "-1",
                    id: "menu-item-" + index,
      ...
      _c("template", { slot: "field" }, [
        _c(
          ...
          [
            _c("Dropdown", {
              attrs: {
                label: _vm.field.addButtonLabel,
                blocks: _vm.blocksNames,
              },
            }),
          ],
          1
